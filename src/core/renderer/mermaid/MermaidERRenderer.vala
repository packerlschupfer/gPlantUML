namespace GDiagram {
    public class MermaidERRenderer : Object {
        ...
        public MermaidERRenderer(unowned Gvc.Context ctx, Gee.ArrayList<ElementRegion> regions, string engine) {
            this.context = ctx;
        ...
        public string generate_dot(MermaidERDiagram diagram) {
            ...
            dot.append("  node [fontname=\"Sans\", fontsize=10, shape=box, style=\"rounded,filled\", fillcolor=\"#FFF3E0\"];\n");
        ...
        private void render_entity(StringBuilder dot, MermaidEREntity entity) {
            ...
            if (entity.attributes.size > 0) {
                ...
                label.append("{");
                label.append(RenderUtils.escape_label(entity.name));
                label.append("|");
                ...
                foreach (var attr in entity.attributes) {
                    ...
                    string attr_str = attr.name;
                    if (attr.type_name != null) {
                        attr_str += ": " + attr.type_name;
                    }
                    label.append(RenderUtils.escape_label(attr_str));
                }
            ...
            // Store region
            regions.add(new ElementRegion(entity.name, entity.source_line, 0, 0, 0, 0));
        }
